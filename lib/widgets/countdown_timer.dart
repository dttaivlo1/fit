...
import 'package:fit_app/google_fit_api/health.dart';
    ...
    _controller = AnimationController(
      ...
      ..addStatusListener((status) {
        ...
        if (status == AnimationStatus.completed &&
          ...
          print(_durationStatusList.workDuration.inSeconds*_durationStatusList.sets*_durationStatusList.reps);
          HealthFlutter().addData(_durationStatusList.workDuration.inSeconds*_durationStatusList.sets*_durationStatusList.reps)
          .then((value) => {
