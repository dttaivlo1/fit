...
class MediterranesnDietView extends StatelessWidget {
  ...
  const MediterranesnDietView(
      {Key? key, this.animationController, this.animation, required this.healthDataPoints})
      : super(key: key);

  @override
  Widget build(BuildContext context) {
    double totalSpend = 0;
    healthDataPoints.forEach((x) => totalSpend += double.parse(x.value.toString()));
                                                ...
                                                Padding(
                                                  padding:
                                                      const EdgeInsets.only(
                                                          left: 4, bottom: 3),
                                                  child: Text(
                                                    '${(totalSpend * animation!.value).toInt()}',
                                                    textAlign: TextAlign.center,
                                                    style: TextStyle(
                                                      fontFamily:
                                                          HealthAppTheme
